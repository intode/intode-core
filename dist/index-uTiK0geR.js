import { E as f, a as p, L as x, h as X, p as y, s as h, b as G, c as Z, t as Q, i as S, d as b, f as j, e as V, g as c } from "./index-DEh5hn1d.js";
const W = 1, k = 2, w = 3, v = 180, R = 4, _ = 181, z = 5, E = 182, U = 6;
function D(O) {
  return O >= 65 && O <= 90 || O >= 97 && O <= 122;
}
const F = /* @__PURE__ */ new c((O) => {
  let a = O.pos;
  for (; ; ) {
    let { next: r } = O;
    if (r < 0)
...
const C = /* @__PURE__ */ u("endcomment", E, z), Y = /* @__PURE__ */ u("endraw", _, R), N = /* @__PURE__ */ new c((O) => {
  if (O.next == 35) {
    for (O.advance(); !(O.next == 10 || O.next < 0 || (O.next == 37 || O.next == 125) && O.peek(1) == 125); )
      O.advance();
    O.acceptToken(U);
  }
}), I = { __proto__: null, contains: 34, or: 38, and: 38, true: 52, false: 52, empty: 54, forloop: 57, tablerowloop: 59, continue: 61, in: 131, with: 197, for: 199, as: 201, if: 237, endif: 241, unless: 247, endunless: 251, elsif: 255, else: 259, case: 265, endcase: 269, when: 273, endfor: 281, tablerow: 287, endtablerow: 291, break: 295, cycle: 301, echo: 305, render: 309, include: 313, assign: 317, capture: 323, endcapture: 327, increment: 331, decrement: 335 }, L = { __proto__: null, if: 86, endif: 90, elsif: 94, else: 98, unless: 104, endunless: 108, case: 114, endcase: 118, when: 122, for: 128, endfor: 138, tablerow: 144, endtablerow: 148, break: 152, continue: 156, cycle: 160, comment: 166, endcomment: 172, raw: 178, endraw: 184, echo: 188, render: 192, include: 204, assign: 208, capture: 214, endcapture: 218, increment: 222, decrement: 226, liquid: 230 }, H = /* @__PURE__ */ V.deserialize({
  version: 14,
  ...
  specialized: [{ term: 187, get: (O) => I[O] || -1 }, { term: 39, get: (O) => L[O] || -1 }],
  tokenPrec: 0
});
function l(O, a) {
  return O.split(" ").map((r) => ({ label: r, type: a }));
}
const P = /* @__PURE__ */ l("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), m = /* @__PURE__ */ l("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), T = /* @__PURE__ */ l("empty forloop tablerowloop in with as", "keyword"), A = /* @__PURE__ */ l("first index index0 last length rindex", "property"), B = /* @__PURE__ */ l("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function M(O) {
  var a;
  let { state: r, pos: n } = O, $ = h(r).resolveInner(n, -1).enterUnfinishedNodesBefore(n), i = ((a = $.childBefore(n)) === null || a === void 0 ? void 0 : a.name) || $.name;
  if ($.name == "FilterName")
  ...
  return e ? { type: "expression", from: e.from } : O.explicit && $.name != "CommentText" && $.name != "StringLiteral" && $.name != "NumberLiteral" && $.name != "InlineComment" ? { type: "expression" } : null;
}
function K(O, a, r, n) {
  let $ = [];
  for (; ; ) {
...
function J(O = {}) {
  let a = O.filters ? O.filters.concat(P) : P, r = O.tags ? O.tags.concat(m) : m, n = O.variables ? O.variables.concat(T) : T, { properties: $ } = O;
  return (i) => {
    var e;
    let t = M(i);
    if (!t)
      return null;
    let o = (e = t.from) !== null && e !== void 0 ? e : t.node ? t.node.from : i.pos, s;
    return t.type == "filter" ? s = a : t.type == "tag" ? s = r : t.type == "expression" ? s = n : s = K(i.state, t.target, i, $), s.length ? { options: s, from: o, validFor: /^[\w\u00c0-\uffff]*$/ } : null;
  };
}
const OO = /* @__PURE__ */ f.inputHandler.of((O, a, r, n) => n != "%" || a != r || O.state.doc.sliceString(a - 1, r + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange(($) => ({
  ...
  parser: /* @__PURE__ */ H.configure({
    props: [
      /* @__PURE__ */ Z({
        ...
        "if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue": Q.controlKeyword,
        ...
        TagName: Q.tagName,
        FilterName: /* @__PURE__ */ Q.function(Q.variableName),
      ...
      /* @__PURE__ */ j.add({
        "UnlessDirective ForDirective TablerowDirective CaptureDirective IfDirective CaseDirective RawDirective Comment"(O) {
          let a = O.firstChild, r = O.lastChild;
...
function g(O) {
  return $O.configure({
    wrap: y((a) => a.type.isTop ? {
      parser: O.parser,
      overlay: (r) => r.name == "Text" || r.name == "RawText"
    } : null)
  }, "liquid");
}
const aO = /* @__PURE__ */ g(q.language);
function iO(O = {}) {
  let a = O.base || q, r = a.language == q.language ? aO : g(a.language);
  return new x(r, [
    a.support,
