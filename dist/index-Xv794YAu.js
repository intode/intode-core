import { L as r, k as i, b as n, i as $, l as y, f as P, m as X, e as m, g as S, c, t as O } from "./index-BIgq-9N6.js";
...
const W = /* @__PURE__ */ new S((T, Q) => {
  ...
  PseudoClassName: /* @__PURE__ */ O.constant(O.className),
  IdName: O.labelName,
  ...
  "AtKeyword Interpolation": /* @__PURE__ */ O.special(O.variableName),
  ...
  Escape: /* @__PURE__ */ O.special(O.string),
  ": ...": O.punctuation,
  ...
  "[ ]": O.squareBracket,
  "{ }": O.brace
}), z = { __proto__: null, lang: 40, "nth-child": 40, "nth-last-child": 40, "nth-of-type": 40, "nth-last-of-type": 40, dir: 40, "host-context": 40, and: 244, or: 244, not: 74, only: 74, url: 86, "url-prefix": 86, domain: 86, regexp: 86, when: 117, selector: 142, from: 172, to: 174 }, h = { __proto__: null, "@import": 126, "@plugin": 126, "@media": 152, "@charset": 156, "@namespace": 160, "@keyframes": 166, "@supports": 178 }, g = /* @__PURE__ */ m.deserialize({
  version: 14,
  ...
  specialized: [{ term: 116, get: (T) => z[T] || -1 }, { term: 23, get: (T) => h[T] || -1 }],
  tokenPrec: 2180
}), o = /* @__PURE__ */ n.define({
  name: "less",
...
}), u = /* @__PURE__ */ i((T) => T.name == "VariableName" || T.name == "AtKeyword");
function R() {
  return new r(o, o.data.of({ autocomplete: u }));
}
export {
  R as less,
  u as lessCompletionSource,
  o as lessLanguage
};
