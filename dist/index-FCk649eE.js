import { b as p, L as u, h as l, p as n, c as b, t, n as m, e as c, j as r } from "./index-DEh5hn1d.js";
const S = /* @__PURE__ */ c.deserialize({
  ...
  tokenPrec: 157
}), P = /* @__PURE__ */ m.parser.configure({
  top: "SingleExpression"
}), s = /* @__PURE__ */ S.configure({
  props: [
    /* @__PURE__ */ b({
      Text: t.content,
  ...
  top: "Attribute"
}), y = { parser: Q }, R = { parser: g }, a = /* @__PURE__ */ l();
function i(O) {
  return O.configure({
    dialect: "selfClosing",
    wrap: n(X)
