import { e as v, g as i, C as _, c as W, t as e, L as g, k as x, b as V, f as p, m as E, i as U, l as N } from "./index-Ca1Wui1b.js";
const j = 168, X = 169, C = 170, I = 1, D = 2, w = 3, L = 171, F = 172, Y = 4, z = 173, K = 5, A = 174, T = 175, Z = 176, s = 177, G = 6, k = 7, B = 8, H = 9, c = 0, R = [
  ...
  8287,
  12288
], M = 58, J = 40, m = 95, OO = 91, l = 45, $O = 46, f = 35, eO = 37, u = 123, QO = 125, d = 47, S = 42, r = 10, q = 61, tO = 43, aO = 38;
function o(O) {
...
const nO = new i((O, $) => {
  ...
  (O.next == tO || O.next == q) && $.dialectEnabled(c) && O.acceptToken(O.next == q ? B : H, 1);
}), iO = new i((O, $) => {
...
}), YO = /* @__PURE__ */ x((O) => O.name == "VariableName" || O.name == "SassVariableName");
function TO(O) {
