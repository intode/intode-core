import { b as g, L as P, h as q, p as l, n as i, c, t as r, e as R, g as p } from "./index-0OKspXD2.js";
const b = 1, $ = 33, m = 34, v = 35, x = 36, W = /* @__PURE__ */ new p((O) => {
  ...
  for (; ; ) {
    if (O.next == 10) {
      O.advance();
      break;
    } else if (O.next == 123 && O.peek(1) == 123 || O.next < 0)
      break;
    O.advance();
  }
  O.pos > e && O.acceptToken(b);
});
function n(O, e, a) {
  return new p((t) => {
    let u = t.pos;
    for (; t.next != O && t.next >= 0 && (a || t.next != 38 && (t.next != 123 || t.peek(1) != 123)); )
      t.advance();
    t.pos > u && t.acceptToken(e);
  });
}
const d = /* @__PURE__ */ n(39, $, !1), C = /* @__PURE__ */ n(34, m, !1), T = /* @__PURE__ */ n(39, v, !0), f = /* @__PURE__ */ n(34, x, !0), A = /* @__PURE__ */ R.deserialize({
  version: 14,
  ...
  props: [
    /* @__PURE__ */ c({
      ...
      "EventName/Identifier": /* @__PURE__ */ r.special(r.attributeName),
  ...
  top: "Attribute"
}), E = { parser: U }, N = { parser: y }, s = /* @__PURE__ */ q({ selfClosingTags: !0 });
function S(O) {
  return O.configure({ wrap: l(z) }, "angular");
}
const k = /* @__PURE__ */ S(s.language);
function z(O, e) {
  switch (O.name) {
    case "Attribute":
      return /^[*#(\[]|\{\{/.test(e.read(O.from, O.to)) ? N : null;
    case "Text":
      return E;
  }
  return null;
...
function G(O = {}) {
  ...
  return new P(e.language == s.language ? k : S(e.language), [e.support, e.language.data.of({
